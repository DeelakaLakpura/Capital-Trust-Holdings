          ...
          <div class="row align-items-center">
                ...
                <div id="part-one" > 
                    ...
                    <div class="d-flex flex-md-row flex-column ">
                        ...
                        <div class="col mb-1 mx-3">
                            <div class="input-group mb-3">
                                ...
                                <option value="forBuy">Sale</option>
                    ...
                    <div class="d-flex flex-column flex-md-row">
                        ...
                        <div class="col  mb-3 mx-3">
                            <div class="input-group ">
                                <input maxlength="10" required name="bed_rooms" min="0" type="number" class="form-control form-control-lg bg-light fs-6" placeholder="Bed Rooms">   
                            </div>
                        </div>
                    </div>
                    <div class="d-flex flex-column flex-md-row">
                        <div class="col  mb-3 mx-3">
                            <div class="input-group ">
                                <input maxlength="10" required name="bath_rooms" min="0"  type="number" class="form-control form-control-lg bg-light fs-6" placeholder="Bath Rooms">   
                            </div>
                        </div>
                        <div class="col  mb-3 mx-3">
                            <div class="input-group ">
                                <input maxlength="10" required name="square_feet" step="any" min="0"  type="number" class="form-control form-control-lg bg-light fs-6" placeholder="Square Feet">   
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-md-row flex-column ">
                    ...
                    <div class="d-flex flex-md-row flex-column ">
                        <div class="col mb-1 mx-3">
                            <div class="input-group mb-3">
                                <select name="furnished" required class="form-control form-control-lg bg-light fs-6" >
