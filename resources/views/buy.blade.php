...
<a href="#" style="height:30px; overflow:hidden" class="alt-font text-dark-gray fw-700 fs-22 me-10px">{{$property->title}}</a>
</div>
...
<span class="fw-600 alt-font text-dark-gray">{{$property->square_feet}} sq. feet</span>
</div>
