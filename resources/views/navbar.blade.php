                            ...
                            <div class="dropdown-menu submenu-content" aria-labelledby="navbarDropdownMenuLink1">
                                <div class="d-lg-flex mega-menu m-auto ps-5 pe-5 md-ps-0 md-pe-0 md-pt-15px">
                                    <div class="row row-cols-2 row-cols-lg-5 row-cols-sm-3 w-100 mx-0 align-items-center justify-content-center">
                                        ...
                                        <div class="col md-mb-30px">
                                            <a href="/rent/residantial-land" class="opacity-10 text-center justify-content-center flex-column d-flex">
                                                <span class="w-100px h-100px mb-15px mx-auto bg-white d-flex justify-content-center border-radius-100px box-shadow-large box-shadow-large-hover position-relative">
                                                    <img src="/images/main/demo-real-estate-icon-home.svg" class="w-40px" alt="Residential Land">
                                                </span>
                                                <span class="alt-font fw-600 fs-15 text-dark-gray">Residential Land</span>
                                            </a>
                                        </div>
                            ...
                            <div class="dropdown-menu submenu-content" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="d-lg-flex mega-menu m-auto ps-5 pe-5 md-ps-0 md-pe-0 md-pt-15px">
                                    <div class="row row-cols-2 row-cols-lg-5 row-cols-sm-3 w-100 mx-0 align-items-center justify-content-center">
                                        ...
                                        <div class="col md-mb-30px">
                                            <a href="/buy/residantial-land" class="opacity-10 text-center justify-content-center flex-column d-flex">
                                                <span class="w-100px h-100px mb-15px mx-auto bg-white d-flex justify-content-center border-radius-100px box-shadow-large box-shadow-large-hover position-relative">
                                                    <img src="/images/main/demo-real-estate-icon-home.svg" class="w-40px" alt="Residential Land">
                                                </span>
                                                <span class="alt-font fw-600 fs-15 text-dark-gray">Residential Land</span>
