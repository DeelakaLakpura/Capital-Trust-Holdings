...
@endforeach
  ...
  <div class="container overlap-gap-section">
    <div class="row">
      <div class="col-12">
        <ul class="blog-classic blog-wrapper grid-loading grid grid-4col xl-grid-4col lg-grid-4col md-grid-4col sm-grid-4col xs-grid-1col gutter-extra-large" data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 200, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
          <li class="grid-sizer"></li>
          
          @forelse ($newss as $news)
            <li class="grid-item">
              <div class="card bg-transparent border-0 h-100 shadow-lg rounded-lg overflow-hidden" style="max-width: 350px;">
                <div style="height:230px; width:100%;" class="blog-image position-relative overflow-hidden border-radius-6px">
                  @if(!$news->link)   
                    <a href="detailedNews/{{$news->id}}"><img class="w-100 h-100 object-fit-cover" src="/images/{{$news->image}}" alt /></a>
                  @else
                    <a href="{{$news->link}}"><img class="w-100 h-100 object-fit-cover" src="/images/{{$news->image}}" alt /></a>
                  @endif        
                </div>
                <div class="card-body px-3 py-4 xs-py-2">
                  ...
                  <p class="card-title alt-font fw-600 lh-30 text-dark-gray d-inline-block w-95 fs-19 mt-3">{{$news->title}}</p>
                </div>
              </div>
            </li>
          @empty
