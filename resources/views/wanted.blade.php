    ...
    <!----------------------- Login Container -------------------------->
     <div class="d-flex border justify-content-center rounded-5 p-3 bg-white shadow box-area">
          ...
          <div class="row align-items-center">
                ...
                <div class="col  mx-3">
                        <textarea onkeyup="addPlaceholderText(this)" onclick="shiftPlaceholderText(this)" class="form-control form-control-lg bg-light fs-6" name="requirement">Requirements</textarea>  
                </div>
